...
import { getDoctorDetails } from '@/utils/web3';
  ...
  useEffect(() => {
    const fetchDoctorProfile = async () => {
      try {
        ...
        // Buscar detalhes do médico
        const doctorDetails = await getDoctorDetails(userData.address);
          ...
          <Card className="max-w-2xl mx-auto">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="crm" value={profile.crm} readOnly />
              </div>
              <div className="space-y-2">
